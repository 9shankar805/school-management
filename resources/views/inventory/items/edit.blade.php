        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4" style="max-width:800px">
                    ...
                    <h1 class="display-6 mb-1"><i class="bi bi-box-seam"></i> Edit Item</h1>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('inventory.items.update', $item->id) }}">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select name="unit" class="form-select" required>
                                            ...
                                            <option value="{{ $k }}" @selected(old('unit',$item->unit)==$k)>{{ $v }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="warehouse_id" class="form-select">
                                            ...
                                            <option value="{{ $wid }}" @selected(old('warehouse_id',$item->warehouse_id)==$wid)>{{ $wname }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select name="supplier_id" class="form-select">
                                            ...
                                            <option value="{{ $sid }}" @selected(old('supplier_id',$item->supplier_id)==$sid)>{{ $sname }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Update Item</button>
